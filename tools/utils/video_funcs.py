...
"""
import numpy as np
from tools.utils.metrics import softmax


def default_aggregation_func(score_arr, normalization=True, crop_agg=None, multi_crop=1):
    """
...
#    print(multi_crop)
    ...
    if multi_crop:
        ...
        if normalization:
            softmax(score_arr.mean(axis=0))
        else:
            return score_arr.mean(axis=0)
