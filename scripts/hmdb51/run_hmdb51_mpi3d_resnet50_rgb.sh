#!/usr/bin/env bash
python train_i3d_resnet50.py --train_list data/hmdb51/hmdb51_rgb_train_split_1.txt \
--val_list data/hmdb51/hmdb51_rgb_val_split_1.txt \
--cluster_list data/hmdb51_rgb_train_cluster_split_1.txt \
--cluster_train 0 \
--dataset hmdb51 \
--mode rgb --arch mp_resnet50_3d \
--save_model checkpoints/ \
--lr 0.002 --lr_steps 15 25 35 --epochs 45 --batch-size 14 \
