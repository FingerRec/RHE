...
# -*- coding: utf-8 -*-
"""
     # @Time    : 2019-03-22 09:44
     # @Author  : Awiny
     # @Site    :
     # @Project : pytorch_i3d
     # @File    : non_local_i3d.py
     # @Software: PyCharm
...
from net.basic_models.non_local import NONLocalBlock3D
...
class NonLocalI3d(nn.Module):
    ...
    def __init__(self, num_classes=400, spatial_squeeze=True,
        ...
        super(NonLocalI3d, self).__init__()
        ...
        if self._final_endpoint == end_point: return
        '''
        end_point = 'non_local_block_1'
        self.end_points[end_point] = NONLocalBlock3D(256 + 320 + 128 + 128)
        if self._final_endpoint == end_point: return
        '''
        end_point = 'Mixed_5b'
        ...
        self.spp_layer = SpatialPyramidPool3D(out_side=(1, 2, 4, 8))
...
def transfer_learning_stragety(model, lr):
    ...
    ft_module_names.append('logits')
    ft_module_names.append('path2_de_logits')
    ft_module_names.append('non_local_block_1')
    parameters = []
    l = 0
    len = 0
