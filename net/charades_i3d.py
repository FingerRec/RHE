...
# -*- coding: utf-8 -*-
"""
     # @Time    : 2019-04-23 18:58
     # @Author  : Awiny
     # @Site    :
     # @Project : pytorch_i3d
     # @File    : charades_i3d.py
     # @Software: PyCharm
...
class CharadesI3d(nn.Module):
    def __init__(self, num_classes=400, spatial_squeeze=True, in_channels=3, dropout_prob=0.5):
        ...
        self.logits_custom = Unit3D(in_channels=384 + 384 + 128 + 128, output_channels=num_classes,
                             kernel_shape=[1, 1, 1],
                             padding=0,
                             activation_fn=None,
                             use_batch_norm=None,
    ...
    def forward(self, x):
        ...
        #path_m = self.m_depend(path_m) # may be can use path_m to locate, which is 16, more accurate than 8
        ...
        return torch.sigmoid(logits) #,main_path, path_s, path_m, path_l,